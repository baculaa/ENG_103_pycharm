...
class eng103_base1:
    ...
    def set_colors_assignment_2(self, n):
        ...
        ##### STOP EDITING HERE #####
        ### DO NOT EDIT BELOW THIS LINE!! ###
        marker_style = dict(marker = marker_type, markerfacecolor = marker_fill_color, markerfacecoloralt=marker_fill_color2, markersize = marker_size, markeredgecolor=marker_edge_color, fillstyle=fill_style)
...
if __name__ == '__main__':
    ...
    for n in range(data_length):
        ...
        plt.title("Alexandra Bacula, Assignment 1&2 Solution")
        ##### STOP EDITING HERE #####
