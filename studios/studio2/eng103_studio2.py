...
def Plot_Paintings(Wall_Length, Painting_Length, Num_Paintings, Wall_Height, Painting_Height):
	...
	# Write your If Else statement to tell the user if the paintings fit
	##########################
	#________________________________
...
if __name__ == '__main__':
	Plot_Paintings(Wall_Length = 15, Painting_Length = 1, Num_Paintings = 12 , Wall_Height = 5, Painting_Height = 3)
