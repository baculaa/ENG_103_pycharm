...
if __name__ == '__main__':
    ...
    ## Plot a rectangle
    # INPUTS: corner1_x,corner1_y,corner2_x,corner2_y,outline_color,outline_width,fill_color,fill_opacity
    creative_code.plot_rectangle(0,0,3,2,'black',6,'purple',0.5)

    ## Plot a circle
    # INPUTS: center_x,center_y,radius,outline_color,outline_width,fill_color,fill_opacity
    creative_code.plot_circle(0,0,2,'red',6,'yellow',0.5)
